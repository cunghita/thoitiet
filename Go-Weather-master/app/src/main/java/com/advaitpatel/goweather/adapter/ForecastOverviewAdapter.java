...
/**
 * Created by HoangDat on 30.04.2021
 */
...
public class ForecastOverviewAdapter extends RecyclerView.Adapter<ForecastOverviewAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvhum, tvwind, tvpre;
        public TextView tvMaxTemp, tvMinTemp;
        public ImageView ivWeatheric;
        public LinearLayout cvCard, relative;
        // We also create a constructor that accepts the entire item row
        // and does the view lookups to find each subview
        public ViewHolder(View itemView) {
            super(itemView);
            this.tvDayName = (TextView) itemView.findViewById(R.id.tvNa);
            ...
            this.tvhum = (TextView) itemView.findViewById(R.id.humidity);
            this.tvwind = (TextView) itemView.findViewById(R.id.windspeed);
            this.tvpre = (TextView) itemView.findViewById(R.id.pressure);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final Date time = new Date((long)timestamp*1000);
        final SimpleDateFormat sdf = new SimpleDateFormat("EEEE, dd.");
        ...
        holder.tvhum.setText(songs.humidity + "%");
        holder.tvwind.setText(songs.windspeed + "km/h");
        holder.tvpre.setText(songs.pressoure + "m/Bar");

        Intent intent = new Intent(context,ForecastOverviewAdapter.class);
        intent.putExtra("tvDayName",songs.time);
    }
