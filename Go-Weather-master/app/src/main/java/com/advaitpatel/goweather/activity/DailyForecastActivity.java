...
/**
 * Created by HoangDat on 29.04.2021
 */
public class DailyForecastActivity extends BaseActivity {
    ...
    public void downloadJSON() {
         ...
         * Get settings
         */
        city = SharedPreferences.getString("location", "HaNoi");
        CountryCode = SharedPreferences.getString("countrykey", "VN");
        unit = SharedPreferences.getString("unitcode", "metric");
        language = SharedPreferences.getString("lang", "vi");
        /**
