...
public class MainActivity extends BaseActivity{
    ...
    public void getWeatherData(Boolean notification){
         ...
         * Get settings
         */
        city = prefs.getString("location", "Ha tinh");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_share){
            if (downloadSucessfull){
                String sharebody = "Thời tiết của " + city + ", " + CountryCode + ": " + WeatherHelper.getDescription() + " \n" +
                        "Đồng thời có nhiệt độ:" + String.format("%.1f", WeatherHelper.getTemperature_max()) + "°";
